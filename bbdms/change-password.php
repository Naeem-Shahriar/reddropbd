...
?>
	...
	<head>
		<title>Red Drop BD | Change Password</title>
		...
		<div class="appointment py-5">
			<div class="py-xl-5 py-lg-3">
				...
				<div class="d-flex row">
					<div class="appoint-img col-md-6">

					</div>
					<div class="contact-right-w3l appoint-form col-md-4">
						<h5 class="title-w3 text-center mb-5">Change Your Password</h5>

...
?>
	...
	<head>
		<title>Red Drop BD | Request Received</title>
		...
		<div class="appointment py-5">
			<div class="py-xl-5 py-lg-3">
				...
				<div class="d-flex">
					...
					<div class="contact-right-w3l appoint-form table-responsive" style="width:100% !important;">
						<h5 class="title-w3 text-center mb-5">Details Of Requirement</h5>

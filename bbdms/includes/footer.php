  ...
  <div class="w3ls-footer-grids pt-sm-4 pt-3">
    <div class="container py-xl-5 py-lg-3">
        ...
        <div class="col-md-5 w3l-footer">
          <h2 class="mb-sm-3 mb-2">
            <a href="index.php" class="text-white font-italic font-weight-bold">
              <span>RedDrop</span>BD
              <i class="fas fa-tint" style="color:red"></i>
            </a>
          </h2>
          <p>RedDropBD is a socially driven organization committed to saving lives by bridging the gap between blood donors and those in need. We utilize technology to build an accessible and efficient platform where individuals can register as donors, and those in need of blood can easily find and connect with them. </p>
        </div>
      ...
      <div class="border-top mt-5 pt-lg-4 pt-3 pb-lg-0 pb-3 text-center">
        <p class="copy-right-grids mt-lg-1"> <?php echo date("Y"); ?> All rights reserved by <strong>RedDropBD</strong>.
        </p>
      </div>
    </div>
  </div>
